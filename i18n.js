...
const T = {
  ...
  en: {
    ...
    'p.seo.promo': '+ SEO — full base setup that already brings in clients, incl. GEO (Generative Engine Optimization)',
    'p.seo.promo.price': 'CHF 1 000',
  ...
  de: {
    ...
    'p.seo.promo': '+ SEO — vollständige Basis-Einrichtung, die bereits Kunden bringt, inkl. GEO (Generative Engine Optimization)',
    'p.seo.promo.price': 'CHF 1 000',
  ...
  fr: {
    ...
    'p.seo.promo': '+ SEO — configuration de base complète qui amène déjà des clients, GEO inclus (Generative Engine Optimization)',
    'p.seo.promo.price': 'CHF 1 000',
  ...
  it: {
    ...
    'p.seo.promo': '+ SEO — configurazione di base completa che porta già clienti, incl. GEO (Generative Engine Optimization)',
    'p.seo.promo.price': 'CHF 1 000',
